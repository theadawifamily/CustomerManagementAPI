...
class CustomerTierTest extends TestCase
{
    ...
    public function test_customer_tier_is_gold_when_annual_spend_is_exactly_1000_and_purchase_within_last_12_months()
    {
        $customer = Customer::factory()->create([
            'annualSpend' => 1000.00,
            'lastPurchaseDate' => Carbon::now()->subMonths(6),
    ...
    public function test_customer_tier_is_platinum_when_annual_spend_is_exactly_10000_and_purchase_within_last_6_months()
    {
        $customer = Customer::factory()->create([
            'annualSpend' => 10000.00,
            'lastPurchaseDate' => Carbon::now()->subMonths(3),
        ]);
